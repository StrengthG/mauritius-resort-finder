...
function generateHead(meta, baseUrl, siteName, lang, schemaScripts) {
  ...
  const lines = [
    ...
    `  <style>`,
    `    :root{--deep-navy:#08111f;--midnight:#0d1117;--navy-card:#0e1623;--navy-raised:#111a28;--gold:#c9a84c;--gold-dim:#9b7d35;--gold-bright:#e2bc60;--gold-glow:rgba(201,168,76,.12);--champagne:#f5e6c8;--text:#e8dfc8;--text-dim:#c4bba8;--muted:#8b949e;--border:rgba(255,255,255,.07);--border-light:rgba(255,255,255,.12);--border-gold:rgba(201,168,76,.30);--radius:14px;--radius-sm:9px;--radius-lg:20px;--radius-pill:100px;--shadow-hover:0 8px 48px rgba(0,0,0,.6);--ease:cubic-bezier(.4,0,.2,1);--ease-out:cubic-bezier(0,0,.2,1)}`,
    `    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}`,
    `    html{scroll-behavior:smooth;font-size:16px;-webkit-text-size-adjust:100%}`,
    `    body{background:var(--deep-navy);color:var(--text);font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;line-height:1.65;-webkit-font-smoothing:antialiased;padding-top:64px}`,
    `    h1,h2,h3,h4{font-family:'Playfair Display',Georgia,serif;font-weight:700;letter-spacing:-.01em;line-height:1.2;color:var(--champagne)}`,
    `    h1{font-size:clamp(2rem,4.5vw,3.2rem)}h2{font-size:clamp(1.5rem,2.8vw,2.4rem)}h3{font-size:clamp(1rem,1.6vw,1.25rem)}`,
    `    h4{font-size:.9rem;font-family:'Inter',sans-serif;font-weight:700;letter-spacing:0}`,
    ...
    `    .reveal{opacity:0;transform:translateY(28px);transition:opacity .7s var(--ease-out),transform .7s var(--ease-out)}.reveal.is-visible{opacity:1;transform:translateY(0)}`,
    ...
    `    .site-logo{display:flex;align-items:center;gap:10px;font-family:'Playfair Display',serif;font-weight:700;font-size:1rem;color:var(--champagne);letter-spacing:.01em}`,
    `    .site-logo__mark{width:30px;height:30px;border-radius:7px;background:linear-gradient(135deg,var(--gold) 0%,var(--gold-dim) 100%);display:grid;place-items:center;font-size:.85rem;color:var(--deep-navy);font-weight:900;font-family:'Playfair Display',serif;box-shadow:0 2px 10px rgba(201,168,76,.35);flex-shrink:0}`,
    ...
    `    .ranking-summary__heading{font-size:.72rem;font-weight:800;letter-spacing:.12em;text-transform:uppercase;color:var(--muted);margin-bottom:16px;font-family:'Inter',sans-serif}`,
    `    .ranking-summary__list{list-style:none;display:flex;flex-direction:column;gap:10px}.ranking-summary__item{display:flex;align-items:center;gap:14px}.ranking-summary__rank{font-family:'Playfair Display',serif;font-size:.95rem;font-weight:800;color:var(--gold);width:28px;flex-shrink:0}`,
    ...
    `    .hotel-card__score-bar{flex:1;height:5px;background:rgba(255,255,255,.05);border-radius:3px;overflow:hidden}.hotel-card__score-fill{height:100%;border-radius:3px;background:linear-gradient(90deg,var(--gold-dim),var(--gold-bright))}`,
    `    .hotel-card__score-value{font-size:.78rem;font-weight:700;color:var(--gold);width:56px;text-align:right;flex-shrink:0;font-family:'Playfair Display',serif}`,
    ...
    `    .hotel-card__strengths-heading,.hotel-card__weakness-heading,.hotel-card__fit-heading{font-size:.7rem;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:var(--muted);margin-bottom:10px;font-family:'Inter',sans-serif}`,
    ...
    `    .comparison__table thead th{background:var(--navy-card);font-weight:700;color:var(--champagne);font-family:'Playfair Display',serif}.comparison__table tbody tr:nth-child(even){background:var(--navy-card)}.comparison__dim-label{font-weight:600;color:var(--muted)}.comparison__corner{background:var(--deep-navy);border:1px solid var(--border)}`,
    ...
    `    .faq__question{font-family:'Playfair Display',serif;font-size:.95rem;margin-bottom:10px;color:var(--champagne)}.faq__answer p{font-size:.87rem;line-height:1.7}`,
    ...
    `    .disclosure__heading{font-size:.7rem;font-weight:800;text-transform:uppercase;letter-spacing:.12em;color:var(--muted);margin-bottom:10px;font-family:'Inter',sans-serif}`,
    ...
    `    @media(max-width:640px){.container{padding:0 18px}.hotel-card{padding:20px 18px}.hotel-card__score-label{width:60px}.affiliate-cta{flex-direction:column;align-items:flex-start}.site-footer{margin-top:32px;padding:28px 18px}}`,
    `  </style>`,
    ``,

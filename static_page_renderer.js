...
function generateHead(meta, baseUrl, siteName, lang, schemaScripts) {
  ...
  const lines = [
    ...
    `  <script>!function(){var t=localStorage.getItem('mrf-theme')||(matchMedia('(prefers-color-scheme:light)').matches?'light':'dark');document.documentElement.setAttribute('data-theme',t)}()</script>`,
    `  <!-- Google Analytics -->`,

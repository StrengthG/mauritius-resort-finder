...
assert(cardHtml.includes('From USD 1,450/night'), 'renderHotelCard expanded: rate shown');
...
assert(ctaHtml.includes('Booking.com'), 'renderAffiliateCTA: provider shown');

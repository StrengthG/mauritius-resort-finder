...
function _makeRelatedContentBlock(pageContext, position, trustScore) {
  return {
    ...
    payload: {
      ...
      page_type:    pageContext.page_type,
      slug:         pageContext.slug         || null,
      hotel_a_name: pageContext.hotel_a_name || null,
      hotel_a_slug: pageContext.hotel_a_slug || null,
      hotel_b_name: pageContext.hotel_b_name || null,
      hotel_b_slug: pageContext.hotel_b_slug || null,
    },
